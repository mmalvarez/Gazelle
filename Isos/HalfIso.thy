...
abbreviation forget :: "'more \<Rightarrow> 'less" where "forget \<equiv> HalfIso_C_Weak_parm.forget parm"
abbreviation conc :: "'less \<Rightarrow> 'more" where "conc \<equiv> HalfIso_C_Weak_parm.conc parm"
...
abbreviation forget :: "'more \<Rightarrow> 'less" where "forget \<equiv> HalfIso_parm.forget parm"
abbreviation conc :: "'less \<Rightarrow> 'more set" where "conc \<equiv> HalfIso_parm.conc parm"
...
sublocale Iso_Spec \<subseteq> HI : HalfIso_C_Spec
  where parm = "HalfIso_C_Weak_parm.make to_l to_r"
