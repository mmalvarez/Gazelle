...
record ('syn, 'a, 'b) lifting =
  ...
  LOut2 :: "('syn \<Rightarrow> 'b \<Rightarrow> 'a \<Rightarrow> 'a)"
...
"triv_l t =
  ...
  , LOut2 = (\<lambda> s b a . (case b of (mdt b1') \<Rightarrow> (LOut2 t s b1' a)))\<rparr>"
...
"option_l t =
  ...
  , LOut2 = (\<lambda> s b a . (case b of Some b' \<Rightarrow> LOut2 t s b' a))\<rparr>"
...
"prio_l f0 f1 t =
  ...
  , LOut2 =
      (\<lambda> s p1 p2 . (case p1 of
                  mdp m b' \<Rightarrow> LOut2 t s b' p2))\<rparr>"
...
"oalist_l tk tv =
  ...
  , LOut2 = (\<lambda> s l a .  
              (let k = LIn1 tk s a in
                   (case get l k of Some a' \<Rightarrow> LOut2 tv s a' a)))\<rparr>"
