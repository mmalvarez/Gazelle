...
inductive nosem_base_sem::
  " 'g \<Rightarrow> 
    ...
    'mstate \<Rightarrow> 
      ...
      ('garb, 'barb, 'rarb) gensyn \<Rightarrow>  
...
locale GSSemTest =
  fixes base_sem' rec_sem'
begin

overloading
  my_base_sem \<equiv> base_sem
  my_rec_sem \<equiv> rec_sem
begin

definition my_base_sem where
"my_base_sem = nosem_base_sem"

definition my_rec_sem where
"my_rec_sem = nosem_rec_sem"
