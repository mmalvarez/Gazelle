...
(* we may be able to reintroduce *) 
definition base_sem2 :: " 'g \<Rightarrow> 
                      'b \<Rightarrow>
                      'mstate \<Rightarrow> 
                      'mstate \<Rightarrow> 
                      childpath \<Rightarrow>
                      ('arb1, 'arb2, 'arb3) gensyn \<Rightarrow>  
                      ('bxr) gs_result \<Rightarrow>
                      bool" where
"base_sem2 g b m m' cp gs r =
  base_sem g b m m' cp (gs_strip gs) r"
