...
locale Gensyn_Semantics_Base =
  fixes
 base_sem :: " 'g \<Rightarrow> 
                      'b \<Rightarrow>
                      'mstate \<Rightarrow> 
                      'mstate \<Rightarrow> 
                      childpath \<Rightarrow>
                      ('b, _, 'g) gensyn \<Rightarrow>  
                      ('xr) gs_result \<Rightarrow>
                      bool"

locale Gensyn_Semantics_Rec =
  ...
  fixes rec_sem :: "'g \<Rightarrow>
                    ...
                    'mstate \<Rightarrow>
                    childpath \<Rightarrow>
                    (_, 'r, 'g) gensyn \<Rightarrow>
                    ('xr) gs_result \<Rightarrow>
                    bool"


locale Gensyn_Semantics_Sig =
Gensyn_Semantics_Base + Gensyn_Semantics_Rec 
