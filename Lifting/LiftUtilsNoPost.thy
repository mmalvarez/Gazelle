theory LiftUtilsNoPost
 imports  "../Mergeable/MergeableInstances" "../Mergeable/MergeableAList"
begin
...
"plifting_valid l =
  ((\<forall> s a b . LOut l s (LUpd l s a b) = a))"
...
(* TODO: somehow relax this *)
(* one (old) idea: use ordering
   however this would mean that most updates wouldn't go through unless
   everything was wrapped in a priority. But maybe that's what we want? *)
