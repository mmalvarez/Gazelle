theory ViewRef_Comp imports ViewRef
...
(*
     ...
     apply(simp split:sum.splits) 
         ...
         apply(clarsimp)
         apply(frule_tac V2.RefnPrj2) apply(simp) apply(simp)

        apply(clarsimp)
         apply(rule_tac conjI)
          apply(clarsimp)
         apply(frule_tac V2.RefnPrj1) apply(simp) apply(simp)
         apply(rule_tac conjI) apply(clarsimp)
          apply(rule_tac conjI) apply(clarsimp)
  apply(frule_tac V2.InjPrj1)

(*
  RefnPrj3 - proof for first inj' implementation (commented out)
*)
     apply(clarsimp)
     apply(simp split:sum.splits) 
         apply(rule_tac conjI)
        ...
        apply(rule_tac conjI) apply(clarsimp)
         apply(rule_tac conjI) apply(clarsimp)
          apply(rule_tac conjI) apply(clarsimp)
           apply(frule_tac V2.RefnPrj1) apply(simp) apply(clarsimp)
           apply(drule_tac HagreeR)
           apply(drule_tac d' = d' in V1.RefnPrj3) apply(simp) apply(simp)
          apply(clarsimp)
          apply(drule_tac r = x1 in V1.InjBroken) apply(clarsimp)
  ...
  apply(drule_tac HagreeR)
         ...
         apply(clarsimp)
         apply(frule_tac V2.InjBroken) apply(clarsimp)
      ...
      apply(clarsimp)
      apply(drule_tac V2.InjBroken) apply(clarsimp)
  ...
  apply(drule_tac V2.InjPrj1)
          apply(drule_tac V2.RefnPrj1) apply(simp) apply(clarsimp)
  apply(drule_tac HagreeR) apply

          apply(drule_tac V1.InjBroken) apply(clarsimp)
  ...
  apply(clarsimp)
        apply(rule_tac conjI) apply(clarsimp)
         apply(frule_tac V2.RefnPrj1) apply(simp)
         apply(clarsimp)
  apply(drule_tac HagreeR)
         apply(rule_tac conjI) apply(clarsimp)
          apply(rule_tac conjI) apply(clarsimp)
