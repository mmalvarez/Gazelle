theory LatticeLike_Neweqs_simpler imports Main HOL.Transitive_Closure
...
apply(case_tac aa; auto)
  ...
  apply(case_tac aa; auto) apply(case_tac ac; auto)
  apply(case_tac ab; auto)


            apply(drule_tac a = "(None, bb)" and b = "(Some aa, bb)" in ord_leq')
