...
(* note: if both parameters were Pordbs, and we were willing to allow
   Inl bot <[ Inr bot (or vice versa) we could implement Pordb
   question is whether this would be a good idea. *)
