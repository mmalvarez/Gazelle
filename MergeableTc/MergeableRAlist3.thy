...
fun rc_gather' :: "('k :: linorder, 'v) roalist' \<Rightarrow> 'k \<Rightarrow> ('k :: linorder, 'v) roalist'" where
"rc_gather' [] _ = []"
...
qed
*)
fun rc_get :: "('k :: linorder, 'v) roalist' \<Rightarrow> 'k \<Rightarrow> ('v + ('k, 'v) roalist') option" where
"rc_get r k =
  (case map_of r [k] of
...
(* delete a closure *)
fun rc_delete_clos' :: "('k :: linorder) \<Rightarrow> ('k :: linorder, 'v) roalist' \<Rightarrow> ('k, 'v) roalist'" where
"rc_delete_clos' _ [] = []"
