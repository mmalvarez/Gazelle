...
proof(rule sups_presI)
  ...
  show  "\<exists>sup'.
    ...
    using sups_presD[OF H Hnemp_Xs Subs Hfin_Xs H', of Fs_sub f] Hfs_sub Hnemp_Fs_sub Hsub
...
proof-
  ...
  obtain sup' where Sup' : "is_sup ((\<lambda>f. f syn s) ` {f1, f2}) sup'"
    ...
    and Sup'_S : "sup' \<in> S"
    using sups_presD[OF Hf _ Hx12 _  S _ _, of x1 "{f1, f2}"]
    by auto
