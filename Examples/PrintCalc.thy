theory PrintCalc imports
 "../MergeableTc/Mergeable" "../MergeableTc/MergeableInstances" "../MergeableTc/SplittableInstances" HOL.Lifting HOL.Lifting_Set "../MergeSemTc/LiftUtils"
begin
...
value "pcomp print_calc_lc (Smul 9) (mdp 0 (Some (mdt 1)), Some (mdt []))"
value "pcomp' print_calc_lc (Smul 2) (mdp 0 (Some (mdt 1)), Some (mdt []))"
