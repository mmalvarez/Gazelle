...
(* inject existing lifting set. this needs to be distinct from
 * SINJ, otherwise the code generator chokes *)
datatype ('x, 'da, 'db, 'a) sinjects =
  SINJS "('x, 'da, 'db) lifting" "'x \<Rightarrow> 'db set" "'a"
